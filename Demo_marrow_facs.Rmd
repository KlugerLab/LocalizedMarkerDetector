...
tiss <- tiss %>%
  ScaleData(verbose = FALSE, features = c(mmus_s,mmus_g2m)) %>% RunPCA(npcs = 20, verbose = FALSE, features = c(mmus_s,mmus_g2m)) %>% RunTSNE(dims = 1:20, seed.use = 42, reduction.name = "tsne_cc")
