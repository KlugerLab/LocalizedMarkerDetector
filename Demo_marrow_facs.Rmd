...
```{r}
save(gene_partition,dist,gene_hree,cell_block,cell_block_droplet,one_hot_matrix,one_hot_matrix_droplet,jaccard_index,jaccard_index_droplet,file = "./marrow_result/module_result.rdata")
```
...
write.csv(top_enrich_pathway_cc,file = "./marrow_result/reactome_pathway_cc.csv")
```
### Annotate Cell Cycle
```{r}
library(gprofiler2)
...
cell_cycle_table = tiss@meta.data[,c("S.Score","G2M.Score","Phase")]
write.csv(cell_cycle_table,file = "./marrow_result/annotated_cell_cycle.csv")
```


<!-- ## Multi-resolution Modules - analysis -->
<!-- ```{r} -->
